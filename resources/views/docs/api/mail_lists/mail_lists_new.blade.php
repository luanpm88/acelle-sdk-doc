<div id="{{ $resource['name'] }}" class="subsection">
    ...
    <div class="row">
        <div class="col-md-6 pr-5">
            ...
            <p>Make a POST request to the <code class="inline-code">/list</code> resource along with your desired list details to create. On success, a unique <code class="inline-code">List UID</code> key is returned for the newly created list, which is used as a reference key for interacting with it.</p>
