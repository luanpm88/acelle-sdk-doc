<div id="{{ $resource['name'] }}" class="subsection">
    <h2 class="mb-4">Add New Campaign</h2>
    <div class="row">
                ...
                @include('docs.api._curl', [
                    ...
                    'curl' => [
                        ...
                        'params' => [
                            ...
                            ['name' => 'name', 'value' => 'MyCampaign'],
                            ['name' => 'subject', 'value' => 'HelloWorld'],
                            ['name' => 'from_email', 'value' => 'noreply@gmail.com'],
                            ['name' => 'from_name', 'value' => 'NoReply'],
                            ['name' => 'reply_to', 'value' => 'noreply@gmail.com'],
                            ['name' => 'track_open', 'value' => 'true'],
