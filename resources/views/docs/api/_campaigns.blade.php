<div id="{{ $resource['name'] }}" class="subsection">
    ...
    <p class="mb-5">
        IMPORTANT: as of version <code>1.0</code>, Acelle API for campaigns is limited to READ ONLY methods. For setting up and run a campaign, you will need to login to the web UI.
    </p>
