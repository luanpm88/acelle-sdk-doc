<div id="{{ $resource['name'] }}" class="subsection">
    ...
    <p class="mb-5">
        IMPORTANT: as of version <code>1.0</code>, Acelle API for campaigns is limited to READ ONLY methods. For setting up and running a campaign, users will need to login to the web UI.
    </p>
