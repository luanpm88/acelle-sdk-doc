...
<p class="mb-5">A service plan is a combination of hosting resources that you sell to your customers. For example, a plan can provide customers with the contacts/lists management service, a maximum of 10,000 contacts stored on the server, and 1,000,000 marketing email sending credits each month.</p>
