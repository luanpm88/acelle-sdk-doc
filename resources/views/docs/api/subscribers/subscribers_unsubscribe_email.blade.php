        ...
        <div class="col-md-6">                        
            <div class="sticky two-blocks">
                @include('docs.api._curl', [
                    'title' => 'UNSUBSCRIBE',
                    'curl' => [
                        'uri' => 'lists/<span class="hljs-keyword">{list_uid}</span>/subscribers/email/<span class="hljs-keyword">{email}</span>/unsubscribe',
                        'method' => 'PATCH',
                        'params' => [
                    ...
                    'php' => [
                        'function' => "list()->unsubscribeEmail(\$uid = 'e31046fce3d83', \$email = 'ethan@example.com')",
                        'lines' => 5,
                    ],
                ])
