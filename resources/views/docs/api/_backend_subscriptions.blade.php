<div id="{{ $resource['name'] }}" class="subsection">
    ...
    <p class="mb-5">
        ...
        Normally, users can sign up to the system, subscribe to a plan and proceed with the payment. The API is helpful in case you want to quickly assign a plan to a user.
    </p>
